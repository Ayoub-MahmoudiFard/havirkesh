...
class Seeds( SQLAlchemyBase ):
    ...
    seed_name: Mapped[str] = mapped_column(String, unique=True, nullable=False)
    ...
    measure_unit = relationship("MeasurUnites", back_populates="seeds")
    factory_seed = relationship("FactorySeeds", back_populates="seeds")
